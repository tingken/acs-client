<template>
  <div>
    <showHead msg="设备管理">
      <span id="clear_button" class="ver_center extend_button">
        <img class="button_img_size" src="../assets/clear.png">清空
      </span>
      <span id="refresh_button" class="ver_center extend_button">
        <img class="button_img_size" src="../assets/refresh.png">
        刷新
      </span>
      <span id="add_button" class="ver_center extend_button">
  ...
  data: function() {
    return {
      panelProp: {
        ...
        headerMap: {name: '名称', address: '设备位置', ip: 'IP', status: '状态'},
